...
<!--
  This page mirrors the repository root CODE_OF_CONDUCT.md.
  Source of truth: /CODE_OF_CONDUCT.md -- edit there, not here.
...
be reported to the maintainers at **conduct@promptcanary.dev** (placeholder —
update to a real address on repository launch). All complaints will be
